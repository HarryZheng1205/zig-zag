...
@interface ZIGGeneralController ()<UITableViewDataSource,UITableViewDelegate>
{
...
@implementation ZIGGeneralController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row) {
        case 0:
        {
            namelabel.text =  @"About";
        }
            break;
        case 1:
        {
            namelabel.text =  @"Software Update";
        }
            break;
        case 2:
        {
            namelabel.text =  @"Zig-Zag.com";
        }
            break;
        default:
            break;
...
{
    ZIGAboutController * controller = [[ZIGAboutController alloc] initWithNibName:@"ZIGAboutController" bundle:nil];
