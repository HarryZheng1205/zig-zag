...
@interface SIGLedController ()<UITableViewDataSource,UITableViewDelegate>
{
    UITableView * mTableView;
}
@end

@implementation SIGLedController
...
- (void)viewDidLoad {
    ...
    titleLabel.text = @"LED Light Menu";
